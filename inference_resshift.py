...
def get_configs(args):
    ...
    print("Config model checkpoint path",configs.model.ckpt_path)
    print("Config diffusion scale", configs.diffusion.params.sf)
    print("Config autoencoder checkpoint path",configs.autoencoder.ckpt_path)
